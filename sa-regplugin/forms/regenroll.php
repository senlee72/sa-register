            ...
            <div class="form-row">
                <div class="form-group col-md-4 pb-3 pr-3 required">
                    ...
                    <div class="input-group">
                        ...
                        <input type="tel" class="form-control" id="mobileno" name="mobileno" maxlength="10" pattern="[0-9]{10}" size="10" placeholder="enter mobile#" value="" readonly="readonly" required>
                    </div>
                </div>
